	...
	extendParams(materialParams, materialDef, parser) {
		...
		if (metallicRoughness) {
			...
			if (metallicRoughness.baseColorTexture !== undefined) {
				pending.push(
					parser.assignTexture(materialParams, "map", metallicRoughness.baseColorTexture, SRGBColorSpace)
				);
			}
		}
...
class GLTFMaterialsSheenExtension {
	...
	extendMaterialParams(materialIndex, materialParams) {
		...
		if (extension.sheenColorTexture !== undefined) {
			pending.push(
				parser.assignTexture(materialParams, "sheenColorMap", extension.sheenColorTexture, SRGBColorSpace)
			);
		}
...
class GLTFParser {
	...
	loadMaterial(materialIndex) {
		...
		if (materialDef.emissiveTexture !== undefined && materialType !== MeshBasicMaterial) {
			pending.push(
				parser.assignTexture(materialParams, "emissiveMap", materialDef.emissiveTexture, SRGBColorSpace)
			);
		}
